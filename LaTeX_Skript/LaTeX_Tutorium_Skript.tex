...
In die Umgebung kommt dann der Inhalt, der von ihr beeinflusst wird. \par\medskip
\begin{lstlisting}
...
\textbf{Jedes} \LaTeX{}-Dokument muss mindestens aus folgenden Befehlen bestehen:
\begin{lstlisting}
\documentclass{article}
